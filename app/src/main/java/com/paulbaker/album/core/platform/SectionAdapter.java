 ...
 * </ul>
 */
public class SectionAdapter implements com.paulbaker.album.core.platform.SectionPositionIdentifier, com.paulbaker.album.core.platform.SectionNotifier {

    private final transient com.paulbaker.album.core.platform.SectionedRecyclerViewAdapter sectionedAdapter;
    private final transient Section section;

    /* default */ SectionAdapter(final com.paulbaker.album.core.platform.SectionedRecyclerViewAdapter sectionedAdapter, final Section section) {
